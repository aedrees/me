...
def get_some_details():
    ...
    id_1 = int(data["results"][0]["id"]["value"])
    return {"lastName": last_name, "password": password, "postcodePlusID": postcode + id_1}
...
def wordy_pyramid():
    ...
    """
    pyramid = []
    gen_data = open(https://us-central1-waldenpondpress.cloudfunctions.net/give_me_a_word?wordlength=20).read()
